...
const LINK_OBJECTIVES = Object.keys(OBJECTIVE_META); // all 5 outcomes
...
export default function LinkCampaign() {
  ...
  return (
    <CampaignLayout
      accent="pink"
      HeaderIcon={FiLink}
      title="Create Website Campaign"
      subtitle="Drive traffic to your website with website ads"
      name={formData.name}
      setName={(v) => setFormData((prev) => ({ ...prev, name: v }))}
      objectiveValues={LINK_OBJECTIVES}
