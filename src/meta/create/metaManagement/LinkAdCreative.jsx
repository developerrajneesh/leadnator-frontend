    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Create Ad Creative - Website Campaign</h1>
            <p className="text-gray-600 mt-1">Create your ad creative for website</p>
          </div>
        </div>
