  ...
  return (
    <div className="pointer-events-none select-none absolute right-3 bottom-0 w-40 h-24">
      <svg viewBox="0 0 48 60" className="absolute right-16 bottom-7 w-11 h-14 drop-shadow-md" style={{ animation: "ln-float 3s ease-in-out infinite" }}>
        ...
        <path d="M16 36l-6 11 6-5z" fill="#22c55e" />
        <path d="M32 36l6 11-6-5z" fill="#22c55e" />
...
export default function WhatsAppLaunch() {
  ...
  const handleLaunch = async () => {
    ...
    setLoading(true);
    try {
      const adPayload = { adset_id: previousData.adset_id, creative_id: previousData.creative_id, status: "ACTIVE" };
    ...
    return (
      <div className="py-4 px-4 sm:px-6 max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 text-center">
          ...
          <p className="text-gray-500 mb-6" style={{ animation: "ln-rise .5s ease-out .45s both" }}>Your WhatsApp ad is live and will start running shortly.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left mb-6">
            ...
            <SummaryCard icon={<FiSend className="w-4 h-4" />} color="#22c55e" label="Ad ID" value={adId} />
          </div>

          <button onClick={handleGoHome}
            className="px-7 py-3 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold text-sm shadow-lg shadow-green-500/30 hover:-translate-y-0.5 hover:shadow-xl transition-all inline-flex items-center gap-2">
  ...
  return (
    <div className="py-4 px-4 sm:px-6 max-w-4xl mx-auto">
      ...
      <button onClick={() => navigate("/meta/create/whatsapp/creative", { state: previousData })}
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 sm:p-8">
        <div className="flex items-center gap-5 mb-7">
          <div className="relative flex-shrink-0">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-green-100 to-emerald-50/60 grid place-items-center">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-400 to-green-600 grid place-items-center shadow-lg shadow-green-500/30 -rotate-[18deg]">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Launch Your WhatsApp Ad</h1>
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap pt-1">
          ...
          <button onClick={handleLaunch} disabled={loading}
            className="px-7 py-3 rounded-xl bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold text-sm shadow-lg shadow-green-500/30 hover:-translate-y-0.5 hover:shadow-xl transition-all disabled:opacity-60 disabled:cursor-not-allowed inline-flex items-center gap-2">
